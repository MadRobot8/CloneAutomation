...
#**********************************************************************************************
export trgname=GAHINT
export trgdbname=GAHINT
export trgcdbname=GAHCINT
export labdomain="karmalab.net"
export trgappname=${trgname}
export trginstname=${trgcdbname}
export trgdbracenable="N"
export trgdbhost="chcloraebsdb401"
#export trgdbhost2="chcloraebsdb502"
export trgapphost="cheloraebsap701"
export trgadminapphost="cheloraebsap701"
...
export apptargetbasepath="/u01/oracle/GAHINT"
#export trgdbwalletpath="/u01/app/oracle/admin/GAHINT/wallet/tde"
...
export trgapplcsf="/u01/oracle/GAHINT/fs_ne/inst/GAHINT_cheloraebsap701/logs/appl/conc"
export trgapplptmp="/u04/oracle/R12/GAHINT/applptmp"
...
export trgapps_patch_alias='GAHINT_patch'
