...
#**********************************************************************************************
export trgname=ORAFAH
export trgdbname=ORAFAH
export trgcdbname=ORACFAH
export labdomain="karmalab.net"
export trgappname=${trgname}
export trginstname=${trgcdbname}
export trgdbracenable="N"
export trgdbhost="chcloraebsdb402"
#export trgdbhost2="chcloraebsdb502"
export trgapphost="cheloraebsap403"
export trgadminapphost="cheloraebsap403"
...
export apptargetbasepath="/u01/oracle/ORAFAH"
...
export appsrunfsportpool=40
export appspatchfsportpool=41
export appswebport=8040
export trgapplcsf="/appltop/app/oracle/CLONEDB/fs_ne/inst/CLONEDB_chelorappg001/logs/appl/conc"
...
export trgapps_patch_alias='ORAFAH_patch'
