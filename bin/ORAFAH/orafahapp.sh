...
#
#  SYNTAX   : sh <instance name>.sh <sourceappspassword> <sourcewlspassword>
#             sh orasupapp.sh sourceappspassword sourcewlspassword
#
#  Author   : Dinesh Kumar
