...
export srcnbkpclient="phcdoraebsdb202.backup.expecn.com"
...
#**********************************************************************************************
export trgname="ORASUP"
export trgdbname="ORASUP"
export trgcdbname="ORACSUP"
...
export trgadminapphost="${trgapphost}"
...
export apptargetbasepath="/u01/oracle/${trgappname^^}"
export appbackupmgrbase="/u05/oracle/autoclone"
export dbbackupmgrbase="/u05/oracle/autoclone"
export trgdbwalletpath="/u01/app/oracle/admin/ORASUP/wallet/tde"
...
export appsrunfsportpool=20
export appspatchfsportpool=21
export appswebport=8020
export trgapplcsf="/u04/oracle/R12/${trgappname^^}/conc"
export trgapplptmp="/u04/oracle/R12/${trgappname^^}/applptmp"
export trgurl_protocol="http"
export trglocal_url_protocol="${trgurl_protocol}"
export trgwebentryurlprotocol="${trgurl_protocol}"
export trgactive_webport="${appswebport}"
export trgwebssl_port="4463"
export trgwebentryhost="${trgapphost}"
export trghttps_listen_parameter="${trgwebssl_port}"
export trgapphostport="${trgapphost}.${labdomain}:${appswebport}"
export trglogin_page="${trgurl_protocol}://${trgapphostport}/OA_HTML/AppsLogin"
export trgexternal_url="${trgurl_protocol}://${trgapphostport}"
export trgendUserMonitoringURL="${trgexternal_url}/oracle_smp_chronos/oracle_smp_chronos_sdk.gif"
...
export trgapps_patch_alias="${trgappname}_patch"
