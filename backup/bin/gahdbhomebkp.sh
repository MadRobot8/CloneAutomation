...
#******************************************************************************************************##
        ...
        switchdir=/u01/app/oracle/GAHPRD/db/tech_st
...
#******************************************************************************************************##
        ...
        printf "Backup script is already running. Exiting this run at %s !!" "$(date)"  | tee -a  "${logf}"
        exit 1
        else
...
#******************************************************************************************************##
        ...
        mkdir -p "${log_dir}"
        dbhstgloc=/backuprman/ebs_backups/GAHPRD/db_home/"${ORACLE_SID}"
        dbstglocdown=/backuprman/ebs_backups/GAHPRD/db_home
